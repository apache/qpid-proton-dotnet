...
{
   [TestFixture]
   public class DeliveryAnnotationsTypeCodecTest : CodecTestSupport
   {
      [Test]
      public void TestTypeClassReturnsCorrectType()
      {
         Assert.AreEqual(typeof(DeliveryAnnotations), new DeliveryAnnotationsTypeDecoder().DecodesType);
         Assert.AreEqual(typeof(DeliveryAnnotations), new DeliveryAnnotationsTypeEncoder().EncodesType);
      }

      [Test]
      public void TestDescriptors()
      {
         Assert.AreEqual(DeliveryAnnotations.DescriptorCode, new DeliveryAnnotationsTypeDecoder().DescriptorCode);
         Assert.AreEqual(DeliveryAnnotations.DescriptorCode, new DeliveryAnnotationsTypeEncoder().DescriptorCode);
         Assert.AreEqual(DeliveryAnnotations.DescriptorSymbol, new DeliveryAnnotationsTypeDecoder().DescriptorSymbol);
         Assert.AreEqual(DeliveryAnnotations.DescriptorSymbol, new DeliveryAnnotationsTypeEncoder().DescriptorSymbol);
      }

      [Test]
      public void TestDecodeSmallSeriesOfDeliveryAnnotations()
      {
         DoTestDecodeDeliveryAnnotationsSeries(SmallSize, false);
      }

      [Test]
      public void TestDecodeLargeSeriesOfDeliveryAnnotations()
      {
         DoTestDecodeDeliveryAnnotationsSeries(LargeSize, false);
      }

      [Test]
      public void TestDecodeDeliveryAnnotations()
      {
         DoTestDecodeDeliveryAnnotationsSeries(1, false);
      }

      [Test]
      public void TestDecodeSmallSeriesOfDeliveryAnnotationsFromStream()
      {
         DoTestDecodeDeliveryAnnotationsSeries(SmallSize, true);
      }

      [Test]
      public void TestDecodeLargeSeriesOfDeliveryAnnotationsFromStream()
      {
         DoTestDecodeDeliveryAnnotationsSeries(LargeSize, true);
      }

      [Test]
      public void TestDecodeDeliveryAnnotationsFromStream()
      {
         DoTestDecodeDeliveryAnnotationsSeries(1, true);
      }

      private void DoTestDecodeDeliveryAnnotationsSeries(int size, bool fromStream)
      {
         Symbol SYMBOL_1 = Symbol.Lookup("test1");
         Symbol SYMBOL_2 = Symbol.Lookup("test2");
         Symbol SYMBOL_3 = Symbol.Lookup("test3");
         Symbol SYMBOL_4 = Symbol.Lookup("test4");

         DeliveryAnnotations annotations = new DeliveryAnnotations(new Dictionary<Symbol, object>());
         annotations.Value.Add(SYMBOL_1, (byte)128);
         annotations.Value.Add(SYMBOL_2, (ushort)128);
         annotations.Value.Add(SYMBOL_3, (uint)128);
         annotations.Value.Add(SYMBOL_4, (ulong)128);
         ...
         for (int i = 0; i < size; ++i)
         {
            ...
            Assert.IsTrue(result is DeliveryAnnotations);
            ...
            Assert.AreEqual(resultMap[SYMBOL_4], (ulong)128);
         }
      }

      [Test]
      public void TestEncodeDecodeDeliveryAnnotationsArray()
      {
         DoTestEncodeDecodeDeliveryAnnotationsArray(false);
      }

      [Test]
      public void TestEncodeDecodeDeliveryAnnotationsArrayFromStream()
      {
         DoTestEncodeDecodeDeliveryAnnotationsArray(true);
      }

      private void DoTestEncodeDecodeDeliveryAnnotationsArray(bool fromStream)
      {
         Symbol SYMBOL_1 = Symbol.Lookup("test1");
         Symbol SYMBOL_2 = Symbol.Lookup("test2");
         Symbol SYMBOL_3 = Symbol.Lookup("test3");
         ...
         Assert.AreEqual(typeof(DeliveryAnnotations), result.GetType().GetElementType());
      ...
      private void DoTestSkipValue(bool fromStream)
      {
         ...
         for (int i = 0; i < 10; ++i)
         {
            if (fromStream)
            {
               ...
               Assert.AreEqual(typeof(DeliveryAnnotations), typeDecoder.DecodesType);
      ...
      private void DoTestEncodeDecodeMessageAnnotationsWithEmptyValue(bool fromStream)
      {
         ...
         Assert.Throws<EncodeException>(() => encoder.WriteObject(buffer, encoderState, new DeliveryAnnotations()));
      }
      ...
      private void DoTestSkipValueWithInvalidListType(EncodingCodes listType, bool fromStream)
      {
         ...
         buffer.WriteUnsignedByte(((byte)DeliveryAnnotations.DescriptorCode));
      ...
      private void DoTestEncodeDecodeArray(bool fromStream)
      {
         ...
         array[0] = new DeliveryAnnotations(new Dictionary<Symbol, object>());
         ...
         for (int i = 0; i < resultArray.Length; ++i)
         {
            ...
            Assert.IsTrue(resultArray[i] is DeliveryAnnotations);
      ...
      public void DoTestEncodeAndDecodeAnnoationsWithEmbeddedMaps(bool fromStream)
      {
