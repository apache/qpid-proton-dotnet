...
{
   [TestFixture]
   public class DeleteOnNoLinksTypeCodecTest : CodecTestSupport
   {
      [Test]
      public void TestTypeClassReturnsCorrectType()
      {
         Assert.AreEqual(typeof(DeleteOnNoLinks), new DeleteOnNoLinksTypeDecoder().DecodesType);
         Assert.AreEqual(typeof(DeleteOnNoLinks), new DeleteOnNoLinksTypeEncoder().EncodesType);
      }

      [Test]
      public void TestDescriptors()
      {
         Assert.AreEqual(DeleteOnNoLinks.DescriptorCode, new DeleteOnNoLinksTypeDecoder().DescriptorCode);
         Assert.AreEqual(DeleteOnNoLinks.DescriptorCode, new DeleteOnNoLinksTypeEncoder().DescriptorCode);
         Assert.AreEqual(DeleteOnNoLinks.DescriptorSymbol, new DeleteOnNoLinksTypeDecoder().DescriptorSymbol);
         Assert.AreEqual(DeleteOnNoLinks.DescriptorSymbol, new DeleteOnNoLinksTypeEncoder().DescriptorSymbol);
      }

      [Test]
      public void TestDecodeDeleteOnNoLinks()
      {
         DoTestDecodeDeleteOnNoLinks(false);
      }

      [Test]
      public void TestDecodeDeleteOnNoLinksFromStream()
      {
         DoTestDecodeDeleteOnNoLinks(true);
      }

      private void DoTestDecodeDeleteOnNoLinks(bool fromStream)
      {
         IProtonBuffer buffer = ProtonByteBufferAllocator.Instance.Allocate();
         Stream stream = new ProtonBufferInputStream(buffer);

         DeleteOnNoLinks value = DeleteOnNoLinks.Instance;
         ...
         Assert.IsTrue(result is DeleteOnNoLinks);
      }

      [Test]
      public void TestDecodeDeleteOnNoLinksWithList8()
      {
         DoTestDecodeDeleteOnNoLinksWithList8(false);
      }

      [Test]
      public void TestDecodeDeleteOnNoLinksWithList8FromStream()
      {
         DoTestDecodeDeleteOnNoLinksWithList8(true);
      }

      private void DoTestDecodeDeleteOnNoLinksWithList8(bool fromStream)
      {
         IProtonBuffer buffer = ProtonByteBufferAllocator.Instance.Allocate();
         Stream stream = new ProtonBufferInputStream(buffer);
         ...
         buffer.WriteUnsignedByte(((byte)DeleteOnNoLinks.DescriptorCode));
      ...
      [Test]
      public void TestDecodeDeleteOnNoLinksWithList32()
      {
         DoTestDecodeDeleteOnNoLinksWithList32(false);
      }

      [Test]
      public void TestDecodeDeleteOnNoLinksWithList32FromStream()
      {
         DoTestDecodeDeleteOnNoLinksWithList32(true);
      }

      private void DoTestDecodeDeleteOnNoLinksWithList32(bool fromStream)
      {
         IProtonBuffer buffer = ProtonByteBufferAllocator.Instance.Allocate();
         Stream stream = new ProtonBufferInputStream(buffer);
      ...
      private void DoTestSkipValue(bool fromStream)
      {
         ...
         for (int i = 0; i < 10; ++i)
         {
            encoder.WriteObject(buffer, encoderState, DeleteOnNoLinks.Instance);
         }
         ...
         for (int i = 0; i < 10; ++i)
         {
            if (fromStream)
            {
               ...
               Assert.AreEqual(typeof(DeleteOnNoLinks), typeDecoder.DecodesType);
      ...
      private void DoTestEncodeDecodeArray(bool fromStream)
      {
         ...
         array[0] = DeleteOnNoLinks.Instance;
         array[1] = DeleteOnNoLinks.Instance;
         array[2] = DeleteOnNoLinks.Instance;
         ...
         Assert.AreEqual(typeof(DeleteOnNoLinks), result.GetType().GetElementType());
         ...
         for (int i = 0; i < resultArray.Length; ++i)
         {
            ...
            Assert.IsTrue(resultArray[i] is DeleteOnNoLinks);
         }
      }
      ...
      private void DoTestDecodeFailsWhenArrayOfValuesSizeIsToLarge(EncodingCodes arrayType, bool fromStream)
      {
         ...
         if (fromStream)
         {
            ...
            Assert.IsTrue(typeDecoder.ReadValue(stream, streamDecoderState) is DeleteOnNoLinks[]);
         }
         else
         {
            ITypeDecoder typeDecoder = decoder.ReadNextTypeDecoder(buffer, decoderState);
            Assert.AreEqual(typeof(Array), typeDecoder.DecodesType);
            Assert.IsTrue(typeDecoder.ReadValue(buffer, decoderState) is DeleteOnNoLinks[]);
         }
