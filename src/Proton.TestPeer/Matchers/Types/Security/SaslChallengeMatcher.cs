...
namespace Apache.Qpid.Proton.Test.Driver.Matchers.Types.Messaging
{
   ...
   {
      public SaslChallengeMatcher() : base(Enum.GetNames(typeof(SaslChallengeField)).Length, SaslChallenge.DESCRIPTOR_CODE, SaslChallenge.DESCRIPTOR_SYMBOL)
      {
      }

      protected override Type DescribedTypeClassType => typeof(SaslChallenge);
      ...
      public SaslChallengeMatcher WithChallenge(IMatcher m)
      {
         AddFieldMatcher((int)SaslChallengeField.Challenge, m);
         return this;
      }
