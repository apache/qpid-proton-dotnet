...
namespace Apache.Qpid.Proton.Client.Exceptions
{
   ...
   /// </summary>
   public class ClientMessageFormatViolationException : ClientException
   {
      /// <summary>
      /// Creates a new connection message format violation exception.
      /// </summary>
      /// <param name="message">The message that describes the error</param>
      public ClientMessageFormatViolationException(string message) : base(message)
      {
      }
      ...
      public ClientMessageFormatViolationException(string message, Exception innerException) : base(message, innerException)
      {
      }
   }
}