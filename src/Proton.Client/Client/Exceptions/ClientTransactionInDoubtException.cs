...
namespace Apache.Qpid.Proton.Client.Exceptions
{
   ...
   /// </summary>
   public class ClientTransactionInDoubtException : ClientIllegalStateException
   {
      /// <summary>
      /// Creates an instance of this exception with the given message
      /// </summary>
      /// <param name="message">The message that describes the error</param>
      public ClientTransactionInDoubtException(string message) : base(message)
      {
      }
      ...
      public ClientTransactionInDoubtException(string message, Exception innerException) : base(message, innerException)
      {
      }
   }
}