...
namespace Apache.Qpid.Proton.Client.Exceptions
{
   ...
   /// </summary>
   public class ClientDeliveryAbortedException : ClientIllegalStateException
   {
      /// <summary>
      /// Creates an instance of this exception with the given message
      /// </summary>
      /// <param name="message">The message that describes the error</param>
      public ClientDeliveryAbortedException(string message) : base(message)
      {
      }
      ...
      public ClientDeliveryAbortedException(string message, Exception innerException) : base(message, innerException)
      {
      }
   }
}