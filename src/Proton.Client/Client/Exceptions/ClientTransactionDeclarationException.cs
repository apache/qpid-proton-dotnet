...
namespace Apache.Qpid.Proton.Client.Exceptions
{
   ...
   /// </summary>
   public class ClientTransactionDeclarationException : ClientIllegalStateException
   {
      /// <summary>
      /// Creates an instance of this exception with the given message
      /// </summary>
      /// <param name="message">The message that describes the error</param>
      public ClientTransactionDeclarationException(string message) : base(message)
      {
      }
      ...
      public ClientTransactionDeclarationException(string message, Exception innerException) : base(message, innerException)
      {
      }
   }
}