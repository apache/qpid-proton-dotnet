...
{
   public sealed class TransactionalStateTypeDecoder : AbstractDescribedListTypeDecoder
   {
      ...
      protected override TransactionalState ReadType(int count, IProtonBuffer buffer, IDecoder decoder, IDecoderState state)
      {
      ...
      protected override TransactionalState ReadType(int count, Stream stream, IStreamDecoder decoder, IStreamDecoderState state)
      {
         TransactionalState result = new();
