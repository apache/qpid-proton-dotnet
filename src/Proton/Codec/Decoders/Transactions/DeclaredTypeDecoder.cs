...
{
   public sealed class DeclaredTypeDecoder : AbstractDescribedListTypeDecoder
   {
      ...
      protected override Declared ReadType(int count, IProtonBuffer buffer, IDecoder decoder, IDecoderState state)
      {
         Declared result = new();
      ...
      protected override Declared ReadType(int count, Stream stream, IStreamDecoder decoder, IStreamDecoderState state)
      {
         Declared result = new();
