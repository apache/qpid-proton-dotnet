...
{
   public sealed class SaslInitTypeDecoder : AbstractDescribedListTypeDecoder
   {
      ...
      protected override SaslInit ReadType(int count, IProtonBuffer buffer, IDecoder decoder, IDecoderState state)
      {
         SaslInit result = new();
      ...
      protected override SaslInit ReadType(int count, Stream stream, IStreamDecoder decoder, IStreamDecoderState state)
      {
         SaslInit result = new();
