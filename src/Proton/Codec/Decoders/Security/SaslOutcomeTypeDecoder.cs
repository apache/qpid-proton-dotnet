...
{
   public sealed class SaslOutcomeTypeDecoder : AbstractDescribedListTypeDecoder
   {
      ...
      protected override int MinListElements => MinListEntries;

      protected override int MaxListElements => MaxListEntries;

      protected override SaslOutcome ReadType(int count, IProtonBuffer buffer, IDecoder decoder, IDecoderState state)
      {
      ...
      protected override SaslOutcome ReadType(int count, Stream stream, IStreamDecoder decoder, IStreamDecoderState state)
      {
         SaslOutcome result = new();
