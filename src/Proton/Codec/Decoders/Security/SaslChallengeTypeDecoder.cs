...
namespace Apache.Qpid.Proton.Codec.Decoders.Security
{
   public sealed class SaslChallengeTypeDecoder : AbstractDescribedTypeDecoder
   {
      ...
      private SaslChallenge ReadType(IProtonBuffer buffer, IDecoderState state, IListTypeDecoder listDecoder)
      {
      ...
      private SaslChallenge ReadType(Stream stream, IStreamDecoderState state, IListTypeDecoder listDecoder)
      {
         SaslChallenge result = new SaslChallenge();
