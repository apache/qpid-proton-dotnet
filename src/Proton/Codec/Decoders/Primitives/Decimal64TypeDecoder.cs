...
{
   public sealed class Decimal64TypeDecoder : AbstractPrimitiveTypeDecoder
   {
      public override EncodingCodes EncodingCode => EncodingCodes.Decimal64;

      public override Type DecodesType => typeof(Decimal64);
      ...
      {
         ProtonStreamReadUtils.SkipBytes(stream, Decimal64.Bytes);
      }
   }
}