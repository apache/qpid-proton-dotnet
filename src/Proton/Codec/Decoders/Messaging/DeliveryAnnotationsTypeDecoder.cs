...
{
   public sealed class DeliveryAnnotationsTypeDecoder : AbstractDescribedMapTypeDecoder<Symbol>
   {
      ...
      protected override DeliveryAnnotations CreateDescribed(IDictionary<Symbol, object> map)
      {
