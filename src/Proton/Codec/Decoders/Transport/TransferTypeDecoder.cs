...
namespace Apache.Qpid.Proton.Codec.Decoders.Transport
{
   public sealed class TransferTypeDecoder : AbstractDescribedTypeDecoder
   {
      ...
      private Transfer ReadTransfer(IProtonBuffer buffer, IDecoderState state, IListTypeDecoder listDecoder)
      {
      ...
      private Transfer ReadTransfer(Stream stream, IStreamDecoderState state, IListTypeDecoder listDecoder)
      {
         Transfer result = new Transfer();
