...
{
   public sealed class ErrorConditionTypeDecoder : AbstractDescribedListTypeDecoder
   {
      ...
      protected override int MinListElements => MinErrorConditionListEntries;

      protected override int MaxListElements => MaxErrorConditionListEntries;

      protected override ErrorCondition ReadType(int count, IProtonBuffer buffer, IDecoder decoder, IDecoderState state)
      {
      ...
      protected override ErrorCondition ReadType(int count, Stream stream, IStreamDecoder decoder, IStreamDecoderState state)
      {
         Symbol condition = null;
         string description = null;
         IDictionary<Symbol, object> info = null;
