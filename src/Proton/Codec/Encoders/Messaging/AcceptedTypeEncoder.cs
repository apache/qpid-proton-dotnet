...
namespace Apache.Qpid.Proton.Codec.Encoders.Messaging
{
   public sealed class AcceptedTypeEncoder : AbstractDescribedListTypeEncoder<Accepted>
   {
      ...
      protected override EncodingCodes GetListEncoding(Accepted value)
      {
         return EncodingCodes.List0;
      }

      public override void WriteType(IProtonBuffer buffer, IEncoderState state, Accepted value)
      {
      ...
      protected override int GetElementCount(Accepted value)
      {
         return 0;
      }

      protected override void WriteElement(Accepted source, int index, IProtonBuffer buffer, IEncoderState state)
      {
