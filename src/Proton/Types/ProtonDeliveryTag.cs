...
namespace Apache.Qpid.Proton.Types
{
   ...
   /// </summary>
   public sealed class ProtonDeliveryTag : IDeliveryTag
   {
      ...
      public ProtonDeliveryTag(IProtonBuffer tagBuffer)
      {
         if (tagBuffer == null)
         {
