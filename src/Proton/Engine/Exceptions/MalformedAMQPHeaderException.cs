...
namespace Apache.Qpid.Proton.Engine.Exceptions
{
   public sealed class MalformedAMQPHeaderException : ProtocolVioltationException
   {
      ...
      public MalformedAMQPHeaderException(string message) : base(AmqpError.DECODE_ERROR, message)
      {
      }
      ...
      public MalformedAMQPHeaderException(string message, Exception cause) : base(AmqpError.DECODE_ERROR, message, cause)
      {
      }
   }
}