...
{
   /// <summary>
   /// Enumeration of the builtin delivery tag types that the proton
   /// library provides generators for.
   /// </summary>
   public enum ProtonDeliveryTagTypes
   {
      Sequential,
      Uuid,
      Pooled,
   ...
   public static class ProtonDeliveryTagTypesExtensions
   {
